...
if [[ "$(cat /proc/mounts|grep fclust2|wc -l)" == "1" ]];then
    ...
    chown $1:"domain users" "/home/DEPO/$1/users/Redirected folders"
    cd "/home/DEPO/$1/tmp/Redirected folders/"
    echo -e "$(ls -1 )"|pv -S $(du -sb  "/home/DEPO/$1/tmp/Redirected\ folders/"| awk '{print $1}')|parallel -j 10 rsync --info=progress2  -a '{}' "/home/DEPO/$1/users/Redirected\ folders/"
    echo -e "\e[36mOk. Copy Downloads...\e[0m"
    cd "/home/DEPO/$1/Загрузки/"
    echo -e "$(ls -1 /home/DEPO/$1/Загрузки/)"| parallel -j 10 rsync --info=progress2  -a '{}' "/home/DEPO/$1/users/Redirected\ folders/Downloads/"
